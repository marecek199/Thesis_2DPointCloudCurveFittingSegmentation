...
def ransac(pole_bodov,opakovanie,min_pocet_bodov):
    ...
    treshold_ransac = .7*average
    treshold_stvorce = 5*average
    naslednost_indexov = 5
...
def kolinear(pole):
    global min_vzdial
    treshold_vzdialenost_priamok = 40*min_vzdial
...
# vybratie jedneho z merani [0 - 106]
